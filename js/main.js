	...
	barsTooltips = gTooltips.selectAll("rect")
		...
		.append("rect")
			...
			.on("mouseover", function(d) { 
				...
				tooltipTr.append("td").attr("class", "tooltipTdLeft").text("Insgesamter profit:");
				if (d.profit > 0)
				...
				tooltipTr = tooltipTable.append("tr");
				tooltipTr.append("td").attr("class", "tooltipTdLeft").text("Profit pro tag:");
				...
				tooltipTr = tooltipTable.append("tr");
				tooltipTr.append("td").attr("class", "tooltipTdLeftSpace").text("Produktion verkauft:");
				switch (options.produce) {
					case 0: tooltipTr.append("td").attr("class", "tooltipTdRight").text("Rohe Saat"); break;
					case 1: 
						if (d.produce.jar > 0)
							tooltipTr.append("td").attr("class", "tooltipTdRight").text(d.produce.jarType);
						else
							tooltipTr.append("td").attr("class", "tooltipTdRightNeg").text("Keine");
						break;
					case 2:
						if (d.produce.keg > 0)
				...
				tooltipTr = tooltipTable.append("tr");
				tooltipTr.append("td").attr("class", "tooltipTdLeft").text("Dauer:");
				tooltipTr.append("td").attr("class", "tooltipTdRight").text(options.days + " tage");
				tooltipTr = tooltipTable.append("tr");
				tooltipTr.append("td").attr("class", "tooltipTdLeft").text("Ernten:");
				tooltipTr.append("td").attr("class", "tooltipTdRight").text(d.harvests + " mal");

				if (options.extra) {

					tooltip.append("h3").attr("class", "tooltipTitleExtra").text("Saat informationen");
					tooltipTable = tooltip.append("table")
						.attr("class", "tooltipTable")
						.attr("cellspacing", 0);

					tooltipTr = tooltipTable.append("tr");
					tooltipTr.append("td").attr("class", "tooltipTdLeft").text("Wert (Normal):");
					tooltipTr.append("td").attr("class", "tooltipTdRight").text(d.produce.rawN)
						.append("div").attr("class", "gold");
					tooltipTr = tooltipTable.append("tr");
					tooltipTr.append("td").attr("class", "tooltipTdLeft").text("Wert (Silber):");
					tooltipTr.append("td").attr("class", "tooltipTdRight").text(d.produce.rawS)
						.append("div").attr("class", "gold");
					tooltipTr = tooltipTable.append("tr");
					tooltipTr.append("td").attr("class", "tooltipTdLeft").text("Wert (Gold):");
					tooltipTr.append("td").attr("class", "tooltipTdRight").text(d.produce.rawG)
						.append("div").attr("class", "gold");
					tooltipTr = tooltipTable.append("tr");
					if (d.produce.jar > 0) {
						tooltipTr.append("td").attr("class", "tooltipTdLeftSpace").text("Wert (" + d.produce.jarType + "):");
						tooltipTr.append("td").attr("class", "tooltipTdRight").text(d.produce.jar)
						.append("div").attr("class", "gold");
					}
					else {
						tooltipTr.append("td").attr("class", "tooltipTdLeftSpace").text("Wert (Einmachglas):");
						tooltipTr.append("td").attr("class", "tooltipTdRight").text("Keine");
					}
					tooltipTr = tooltipTable.append("tr");
					if (d.produce.keg > 0) {
						tooltipTr.append("td").attr("class", "tooltipTdLeft").text("Wert (" + d.produce.kegType + "):");
						tooltipTr.append("td").attr("class", "tooltipTdRight").text(d.produce.keg)
						.append("div").attr("class", "gold");
					}
					else {
						tooltipTr.append("td").attr("class", "tooltipTdLeft").text("Value (Fass):");
						tooltipTr.append("td").attr("class", "tooltipTdRight").text("Keine");
					}
					...
					if (d.seeds.special > 0) {
						tooltipTr = tooltipTable.append("tr");
						if (first) {
							tooltipTr.append("td").attr("class", "tooltipTdLeftSpace").text("Saat (Spezial):");
							first = false;
						}
						else
							tooltipTr.append("td").attr("class", "tooltipTdLeft").text("Saat (Spezial):");
					...
					tooltipTr = tooltipTable.append("tr");
					tooltipTr.append("td").attr("class", "tooltipTdLeftSpace").text("Zeit zum Wachsen:");
					tooltipTr.append("td").attr("class", "tooltipTdRight").text(d.growth.initial + " tage");
					tooltipTr = tooltipTable.append("tr");
					tooltipTr.append("td").attr("class", "tooltipTdLeft").text("Zeit zum neu Wachsen:");
					if (d.growth.regrow > 0)
						tooltipTr.append("td").attr("class", "tooltipTdRight").text(d.growth.regrow + " tage");
					else
						tooltipTr.append("td").attr("class", "tooltipTdRight").text("N/V");
					if (d.produce.extra > 0) {
						tooltipTr = tooltipTable.append("tr");
						tooltipTr.append("td").attr("class", "tooltipTdLeft").text("Extra produzierung:");
